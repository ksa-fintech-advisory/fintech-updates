  ...
  return (
    <div className="w-full bg-grey-50 min-h-screen">
      ...
      <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-accent-900/30 rounded-full blur-3xl -mr-20 -mt-20"></div>
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-primary-900/20 rounded-full blur-3xl -ml-10 -mb-10"></div>
