...
export default function PrivacyPage({ params }: { params: { locale: string } }) {
  ...
  return (
    <div className="w-full bg-[#030303] min-h-screen text-zinc-100">
      {/* Header Section */}
      <section className="bg-[#050505] text-white py-20 md:py-28 relative overflow-hidden border-b border-white/10">
      ...
      <section className="py-20 md:py-28">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto bg-[#0a0a0b] rounded-3xl p-8 md:p-12 shadow-[0_0_30px_rgba(16,185,129,0.05)] border border-white/10">
