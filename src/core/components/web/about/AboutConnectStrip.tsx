      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="mb-12 md:mb-16">
          <div className="mx-auto max-w-3xl" dir={isArabic ? 'rtl' : 'ltr'}>
            <span className="mb-4 block  text-[10px] font-bold uppercase tracking-[0.2em] text-primary-600 dark:text-primary-400">
            </span>
            ...
            <AnimatedSection key={href} delay={0.06}>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <span className=" text-sm font-bold uppercase tracking-widest text-zinc-900 dark:text-zinc-100">{label}</span>
                </div>
